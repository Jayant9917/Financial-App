...
export function generateLocalBusinessSchema(
  ...
  return {
    ...
    '@type': 'LocalBusiness',
    name: data.name || 'Shivay Finance and Services',
    description: data.description || 'Professional home loan services in Indore, Khandwa, and Bhopal',
    url: data.url || 'https://yourdomain.com',
    ...
    geo: data.geo,
    areaServed: data.areaServed || ['Indore', 'Khandwa', 'Bhopal', 'Madhya Pradesh', 'India'],

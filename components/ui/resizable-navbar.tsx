...
export const NavbarLogo = ({ href = "/" }: { href?: string }) => {
  return (
    ...
    >
      <div className="h-10 w-10 sm:h-12 sm:w-12 flex items-center justify-center overflow-hidden rounded-full bg-white/50 backdrop-blur-sm">
        <video
          autoPlay
          loop
          muted
...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-6 py-3 rounded-md bg-white button bg-white text-black text-base font-bold relative cursor-pointer hover:-translate-y-0.5 transition duration-200 inline-block text-center min-h-[44px]";
